    ...
    <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        <div className='flex items-center justify-center'>
            <div className='relative'>
                ...
                >
                <Image src="/profilePic.png" alt='Photo' width="192" height="192" quality="95" priority={true}
        ...
        >
        <span className="font-bold">Hello, I'm Tomasz.</span> I'm a{" "}
        <span className="font-bold">full-stack developer/freelancer</span> with{" "}
        <span className="font-bold">2 years</span> of non-commercial experience. I enjoy
        ...
        >
          ...
          href='https://www.linkedin.com/in/tomek-wilk-8b7309222/' target='_blank'
          >
            <BsLinkedin />
          </a>
          ...
          href='https://github.com/Wilkubone' target='_blank'
          >
            <FaGithubSquare />
          </a>
        </motion.div>
